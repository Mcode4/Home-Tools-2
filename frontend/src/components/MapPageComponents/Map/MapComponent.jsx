...
import { lngLatToMercator, mercatorToLngLat, mercatorDistance, getHandlePosition, createRadiusData, createLineData } from "../../../functions/map";
...
export default function MapComponent({ 
    ...
    const createLineTool = useCallback((lng, lat, endLng = null, endLat = null, existingId = null, existingName = null) => {
        const map = mapInstance.current;
        if (!map) return;
        const lineId = existingId || `temp-line-${Math.random().toString(36).substr(2, 9)}`, lineName = existingName || "";
